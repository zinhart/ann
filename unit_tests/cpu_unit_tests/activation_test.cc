...
TEST(activation_test, identity_activation)
{
  ...
  // perform activation
  a.activate(layer_info::identity_layer(), objective(), layer_activations_ptr, layer_length);
  ...
  a.activate(layer_info::identity_layer(), derivative(), layer_deltas_ptr, layer_length);
...
TEST(activation_test, softplus_activation)
{
  ...
  // perform activation
  a.activate(layer_info::softplus_layer(), objective(), layer_activations_ptr, layer_length);
  ...
  // perform activation derivative
  a.activate(layer_info::softplus_layer(), derivative(), layer_deltas_ptr, layer_length);
...
TEST(activation_test, tanh_activation)
{
  ...
  // perform activation
  a.activate(layer_info::tanh_layer(), objective(), layer_activations_ptr, layer_length);
  ...
  // perform activation derivative
  a.activate(layer_info::tanh_layer(), derivative(), layer_deltas_ptr, layer_length);
...
TEST(activation_test, relu_activation)
{
  ...
  // perform activation
  a.activate(layer_info::relu_layer(), objective(), layer_activations_ptr, layer_length);
  ...
  // perform activation derivative
  a.activate(layer_info::relu_layer(), derivative(), layer_deltas_ptr, layer_length);
...
TEST(activation_test, leaky_relu_activation)
{
  ...
  // perform activation
  a.activate(layer_info::leaky_relu_layer(), objective(), layer_activations_ptr, layer_length);
  ...
  // perform activation derivative
  a.activate(layer_info::leaky_relu_layer(), derivative(), layer_deltas_ptr, layer_length);
...
TEST(activation_test, exp_leaky_relu_activation)
{
  ...
  // perform activation
  a.activate(layer_info::exp_leaky_relu_layer(), objective(), layer_activations_ptr, layer_length);
  ...
  // perform activation derivative
  a.activate(layer_info::exp_leaky_relu_layer(), derivative(), layer_deltas_ptr, layer_length);
...
TEST(activation_test, softmax_activation)
{
  ...
  // perform activation
  a.activate(layer_info::softmax_layer(), objective(), layer_activations_ptr, layer_length);
