...
namespace zinhart
{  
  void call_sgd(optimizer & op, double & theta, const double & gradient, double eta)
  { op.sgd(theta, gradient, eta); }
  void call_momentum(optimizer & op, double & theta, double & prior_velocity,
	  const double & gradient,  double gamma, double eta)
  { op.momentum(theta, prior_velocity, gradient, gamma, eta); }
  void call_nesterov_momentum(optimizer & op, double & theta, double & prior_velocity, const double & gradient, double gamma, double eta)
  { op.nesterov_momentum(theta, prior_velocity, gradient, gamma, eta); }
  void call_conjugate_gradient(optimizer & op, double & theta, double & prior_gradient, double & hessian, const double & current_gradient, double epsilon)
  { op.conjugate_gradient(theta, prior_gradient, hessian , current_gradient, epsilon); }
  void call_adagrad(optimizer & op, double & theta, double & prior_gradient, const double & current_gradient, double eta, double epsilon)
  ...
  void call_rms_prop(optimizer & op, double & theta, double & prior_gradient, const double & current_gradient, double eta, double beta, double epsilon)
  ...
  void call_adam_moment_update(optimizer & op, double & beta_1_t, double & beta_2_t, double beta_1, double beta_2)
  ...
  void call_adamax_moment_update(optimizer & op, double & beta_1_t,  double beta_1)
  ...
  void call_nadam_moment_update(optimizer & op, double & beta_1_t, double & beta_2_t, double beta_1, double beta_2)
