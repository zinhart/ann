...
namespace zinhart
{
  namespace models
  {
	template <class Precision_Type>
	  class multi_layer_perceptron : public ann< ffn, Precision_Type >
	  {
		public:
		  multi_layer_perceptron() = default;
		  multi_layer_perceptron(const ffn &) = default;
		  multi_layer_perceptron(ffn &&) = default;
		  multi_layer_perceptron & operator = (const ffn &) = default;
		  multi_layer_perceptron & operator = (ffn &&) = default;
		  ~multi_layer_perceptron() = default;
...
#else
  		void forward_propagate(const std::vector<LAYER_INFO> & total_layers,
	  ...
	  template <class LOSS_FUNCTION>
  		void backward_propagate(const std::vector<LAYER_INFO> & total_layers, LOSS_FUNCTION error_metric, 
