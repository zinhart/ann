  ...
  namespace error_metrics
  {
	  ...
	  class loss_function_interface : public loss_function
	  {
		public:
		  ...
		  template <class precision_type>
			CUDA_CALLABLE_MEMBER precision_type operator()( LOSS_FUNCTION_TYPE type, precision_type kth_output, precision_type kth_target);
		  template <class precision_type>
			CUDA_CALLABLE_MEMBER precision_type operator()( LOSS_FUNCTION_TYPE type, precision_type kth_output, precision_type kth_target, precision_type epsilon);
	  };
	...
	class cross_entropy_multi_class : public loss_function_interface<cross_entropy_multi_class>
	{
	  public:
		...
		template <class precision_type>
		  CUDA_CALLABLE_MEMBER precision_type derivative(const precision_type & kth_output, const precision_type & kth_target, const precision_type & epsilon);
	};
